        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="add_staff.php" class="btn btn-sm btn-success"><i class="fas fa-user-plus"></i> Add New Staff</a>
            </div>
          </div>
        </div>
      </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="hrm.php?delete=<?php echo $staff->staff_id; ?>" class="btn btn-sm btn-danger">
